...
#This is a continuation of my final project for the UC Irvine Cybersecurity course. https://github.com/alexjuhan/UCI_Cybersecurity/tree/main/nmap3_input_enabled_FinalProject

#I hope you are able to use this script for your own projects, and continue adding more to it!
...
#   Paste into terminal: pip3 install -r requirements.txt
...
#since I am using Splunk, I have the logs going straight to this directory I created here, which Splunk automatically pulls data from.
